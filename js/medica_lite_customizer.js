jQuery(document).ready(function() {
	...
	jQuery( '.wp-full-overlay-sidebar-content' ).prepend( '<div style="width: 80%; margin: 20px auto; display: block; text-align: center;">'+ medica_lite_buttons.team +'</div>' );
	jQuery( '.wp-full-overlay-sidebar-content' ).prepend( '<a style="width: 80%; margin: 5px auto; display: block; text-align: center;" href="https://themeisle.com/documentation-medica-lite" class="button" target="_blank">'+ medica_lite_buttons.doc +'</a>' );
