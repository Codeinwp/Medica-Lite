				...
				<div class="wrapper cf">
					<div id="header-top" class="cf">
						<div class="header-left cf">
							<a class="logo" href="<?php echo home_url(); ?>" title="Lawyeria">
								<?php
								if ( get_theme_mod( 'ti_header_logo' ) ) {
									echo '<img src="'. get_theme_mod( 'ti_header_logo' ) .'" alt="Medica" title="Medica" />';
								} else {
									echo '<img src="'. get_template_directory_uri() .'/images/header-logo.png" alt="Medica" title="Medica" />';
								}
								?>
							</a><!--/a .logo-->
