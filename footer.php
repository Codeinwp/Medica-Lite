		...
		<footer id="footer">
			<div class="wrapper cf">
				...
				<?php
				if ( get_theme_mod( 'medica_lite_contact_aboutus_title' ) || get_theme_mod( 'medica_lite_footer_aboutus_image' ) || get_theme_mod( 'medica_lite_footer_aboutus_content' ) ) { ?>

					<div class="footer-box">
						<?php
						if ( get_theme_mod( 'medica_lite_contact_aboutus_title' ) ) {
							echo '<div class="footer-box-title">'. get_theme_mod( 'medica_lite_contact_aboutus_title' ) .'</div>';
						}
						?>
						<div class="footer-box-entry">
							<?php
							if ( get_theme_mod( 'medica_lite_footer_aboutus_image' ) ) {
								echo '<img src="'. get_theme_mod( 'medica_lite_footer_aboutus_image' ) .'" class="cf" alt="'. get_theme_mod( 'medica_lite_contact_aboutus_title' ) .'">';
							}
							?>
							<div class="cf"></div>
							<?php
							if ( get_theme_mod( 'medica_lite_footer_aboutus_content' ) ) {
								echo get_theme_mod( 'medica_lite_footer_aboutus_content' );
							}
							?>
				...
				<div class="footer-box">
					<?php
					if ( get_theme_mod( 'medica_lite_contact_menu_title' ) ) {
						echo '<div class="footer-box-title">'. get_theme_mod( 'medica_lite_contact_menu_title' ) .'</div>';
					}
					?>
					<div class="footer-box-entry">
							<?php
				...
				<div class="footer-box">
					...
					if ( get_theme_mod( 'medica_lite_contact_address_title' ) ) {
						echo '<div class="footer-box-title">'. get_theme_mod( 'medica_lite_contact_address_title' ) .'</div>';
					}
					?>
					<div class="footer-box-entry">
						<?php
